use utf8;
package Petty::Schema::Result::PaymentP200702;
...
=head1 TABLE: C<payment_p2007_02>

=cut

__PACKAGE__->table("payment_p2007_02");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WW0lCTPead8vlEU3H9SNEA
