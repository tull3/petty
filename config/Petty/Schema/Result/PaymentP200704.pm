use utf8;
package Petty::Schema::Result::PaymentP200704;
...
=head1 TABLE: C<payment_p2007_04>

=cut

__PACKAGE__->table("payment_p2007_04");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:wW3yhWM2D/zlfhe5mMJvJQ
