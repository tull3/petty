use utf8;
package Petty::Schema::Result::PaymentP200705;
...
=head1 TABLE: C<payment_p2007_05>

=cut

__PACKAGE__->table("payment_p2007_05");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:OZO120HH0KE2SE1Ltl1sUA
