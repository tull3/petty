use utf8;
package Petty::Schema::Result::PaymentP200703;
...
=head1 TABLE: C<payment_p2007_03>

=cut

__PACKAGE__->table("payment_p2007_03");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:y7TCkhMQ4pHqisNCFs8OvA
