use utf8;
package Petty::Schema::Result::PaymentP200706;
...
=head1 TABLE: C<payment_p2007_06>

=cut

__PACKAGE__->table("payment_p2007_06");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:WnNpt1cay7YBi6/8HQKsYw
